describe("Helper: ", function() {
	...
	describe("Pieces: ", function() {
		...
		describe("getPiece()", function() {
			...
			it("should throw an exception if the arguments is out of bounds", function() {
				expect(function() { puzzle.getPiece(-1); }).toThrow();
				expect(function() { puzzle.getPiece( 0); }).toThrow();
				expect(function() { puzzle.getPiece(10); }).toThrow();
				expect(function() { puzzle.getPiece(-1, 1); }).toThrow();
				expect(function() { puzzle.getPiece( 0, 1); }).toThrow();
				expect(function() { puzzle.getPiece(10, 1); }).toThrow();
				expect(function() { puzzle.getPiece(1, -1); }).toThrow();
				expect(function() { puzzle.getPiece(1,  0); }).toThrow();
				expect(function() { puzzle.getPiece(1, 10); }).toThrow();
				expect(function() { puzzle.getPiece([-1, 1]); }).toThrow();
				expect(function() { puzzle.getPiece([ 0, 1]); }).toThrow();
				expect(function() { puzzle.getPiece([10, 1]); }).toThrow();
				expect(function() { puzzle.getPiece([1, -1]); }).toThrow();
				expect(function() { puzzle.getPiece([1,  0]); }).toThrow();
				expect(function() { puzzle.getPiece([1, 10]); }).toThrow();
				expect(function() { puzzle.getPiece({ row: -1, col:  1 }); }).toThrow();
				expect(function() { puzzle.getPiece({ row:  0, col:  1 }); }).toThrow();
				expect(function() { puzzle.getPiece({ row: 10, col:  1 }); }).toThrow();
				expect(function() { puzzle.getPiece({ row:  1, col: -1 }); }).toThrow();
				expect(function() { puzzle.getPiece({ row:  1, col:  0 }); }).toThrow();
				expect(function() { puzzle.getPiece({ row:  1, col: 10 }); }).toThrow();
			});
		});
	});
	...
	describe("Moves: ", function() {
		...
		describe("canMoveByDirection()", function() {
			...
			it("should throw an exception if the direction value is invalid", function() {
				...
				expect(function() { puzzle.canMoveByDirection(0    ); }).toThrow(DIRECTION_INVALID);
				expect(function() { puzzle.canMoveByDirection(false); }).toThrow(DIRECTION_INVALID);
